      ...
      <Card>
        <CardContent className="grid md:grid-cols-4 gap-4 p-4">
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground">Free shipping on order above $100</div>
          </div>
          <div className="space-y-2">
            <DollarSign />
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground">We're here to help you anytime</div>
          </div>
        </CardContent>
      </Card>
    </div>
